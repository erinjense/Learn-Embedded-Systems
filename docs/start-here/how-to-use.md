...
- [ ] <span class="les-tag">Video</span> **Title of the thing** by Author <span class="les-time">~45 min</span>
  One sentence on why this one earned its place.

The tag tells you the format (Video, Article, Book, Course, Docs, Interactive, Tool). A <span class="les-tag les-paid">Paid</span> tag means it costs money; we only include paid items when nothing free is as good, and there is always a free alternative nearby.
...
<div data-les-tools markdown></div>
...
1. Re-read the datasheet section. Really.
2. Reduce the problem: fewer lines, one peripheral, a known-good example.
3. Look at the signal with a logic analyzer or scope. Guessing is slower than measuring.
4. Ask in a community listed in [Module 20](../phase-5-beyond/20-career-and-community.md). Show what you tried.
5. Only then ask an AI, and verify its answer against the datasheet. [Module 18](../phase-5-beyond/18-using-ai-well.md) explains why this order.
